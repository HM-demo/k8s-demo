...
DOCKER_REG=${DOCKER_REG:-https://index.docker.io/v1}
DOCKER_USR=${DOCKER_USR:-sugendh}
DOCKER_PSW=${DOCKER_PSW:-Password123}

DOCKER_REPO=${DOCKER_REPO:-sugendh/k8s-demo}
...
buildDockerImage () {
    ...
    docker build -t ${DOCKER_REPO}:${DOCKER_TAG} ${BUILD_DIR} || errorExit "Building ${DOCKER_REPO}:${DOCKER_TAG} failed"
}
...
pushDockerImage () {
    ...
    docker push ${DOCKER_REPO}:${DOCKER_TAG} || errorExit "Pushing ${DOCKER_REPO}:${DOCKER_TAG} failed"
}
